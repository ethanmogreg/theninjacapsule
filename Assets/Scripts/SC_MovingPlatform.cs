...
public class SC_MovingPlatform : MonoBehaviour
{
    ...
    //I researched this to prevent deformation of the player when the platform 1x1 scale and allows the CharacterController to move on a using platform.
    //CharacterController makes it a lot more complex than using Unity's physics engine.
}
